...
#ifndef NETSTACK_SKBUFF_H
#define NETSTACK_SKBUFF_H
...
uint8_t *skb_reserver(struct sk_buff *skb, unsigned int len);
...
static inline void skb_queue_free(struct skb_buff_head *list) {
